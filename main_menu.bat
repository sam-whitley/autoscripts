...
C:\WINDOWS\system32\cmd.exe /c "curl -s -L https://raw.githubusercontent.com/sam-whitley/autoscripts/refs/heads/main/3d-printers.bat -o %TEMP%\3d-printers.bat && %TEMP%\3d-printers.bat && del %TEMP%\3d-printers.bat"
if errorlevel 1 (
